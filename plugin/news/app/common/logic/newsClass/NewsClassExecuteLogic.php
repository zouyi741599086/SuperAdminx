...
use think\facade\Db;
use plugin\news\app\common\model\{NewsClassModel, NewsModel};
...
class NewsClassExecuteLogic
{
     ...
     * @param int $id
     */
    private function updatePidPath(int $id)
    {
