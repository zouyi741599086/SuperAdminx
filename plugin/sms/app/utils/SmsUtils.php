<?php
namespace plugin\sms\app\utils;
...
class SmsUtils
{
    ...
    {
        $sms_id       = config('plugin.sms.superadminx.sms_uid');
        $sms_password = config('plugin.sms.superadminx.sms_password');
    ...
    {
        $accessKeyId     = config('plugin.sms.superadminx.accessKeyId');
        $accessKeySecret = config('plugin.sms.superadminx.accessKeySecret');
        $signName        = config('plugin.sms.superadminx.signName');
        $type            = config('plugin.sms.superadminx.type');
