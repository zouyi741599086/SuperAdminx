 ...
 * @param {String} filePath 需要预览的pdf的文件路劲，http://xxxx.com/xxx/xxx.pdf  或 /xxx/xxx.pdf
 ...
 */
export default ({ title = 'Pdf内容', filePath = null, button = null, errorMessage = '', height = 650, ...props }) => {
