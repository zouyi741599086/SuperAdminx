...
import { userTotalDayApi } from '@/api/userTotalDay';
...
export default () => {
    ...
    const exportData = () => {
        ...
        userTotalDayApi.exportData(params).then(res => {
        ...
        <>
            <ProTable
                ...
                columnsState={{
                    ...
                    persistenceKey: 'table_column_' + 'UserTotalDay',
                    ...
                    <Space>
                        ...
                        <Tooltip title="根据当前搜索条件导出数据~">
                            <Button
                                ...
                                onClick={exportData}
                                disabled={authCheck('userTotalDayExportData')}
                            >导出</Button>
                        </Tooltip>
                    </Space>
                }
                ...
                request={async (params = {}, sort, filter) => {
                    ...
                    const result = await userTotalDayApi.getList({
                        ...params,// 包含了翻页参数跟搜索参数
                        orderBy, // 排序
                        page: params.current,
                    });
