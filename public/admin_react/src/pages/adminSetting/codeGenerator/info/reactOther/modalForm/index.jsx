...
const ModalForm = ({ tableName, ...props }) => {
    ...
    const prefix = (Field) => {
        return <ProFormText
            key="prefix"
            name={['react_other', 'form_fields_type_config', `${Field}`, `prefix`]}
            placeholder="请输入..."
            fieldProps={{
                prefix: '前缀',
    ...
    const suffix = (Field) => {
        return <ProFormText
            key="suffix"
            name={['react_other', 'form_fields_type_config', `${Field}`, `suffix`]}
            placeholder="请输入..."
            fieldProps={{
                prefix: '后缀',
                style: { margin: '2px 0px' },
        ...
        <DragSortTable
            ...
            columns={[
                ...
                },
                {
                    ...
                    render: (_, record) => <>
                        <ProFormSelect
                            name={['react_other', 'form_fields_type', `${record.Field}`]}
                            placeholder="请选择"
                ...
                },
                {
                    ...
                    width: 350,
                    render: (_, record) => <>
                        <ProFormDependency name={[['react_other', 'form_fields_type', record.Field]]}>
                            {({ react_other }) => {
                                if (react_other?.form_fields_type?.[record.Field]) {
                                    const formType = react_other?.form_fields_type?.[record.Field];
