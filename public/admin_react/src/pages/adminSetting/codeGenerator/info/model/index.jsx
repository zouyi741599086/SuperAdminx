...
import { App, Typography, Space, Flex, Button, Affix, Row, Col, Tooltip, Table } from 'antd';
			...
			>
                ...
                >
                    <ProFormGroup>
                        ...
                        />
                        <ProFormText
                            name="model_plugin_name"
                            label={<>模型所在插件名称<Tooltip title="会从这个插件目录去引入模型，写插件名称即可，空代表在主应用下~"><QuestionCircleOutlined /></Tooltip></>}
                            placeholder="请输入"
