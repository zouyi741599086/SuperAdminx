    ...
    return <>
        <ProForm
            ...
            onFinish={async (values) => {
                adminCodeGeneratorApi.generatorCode({
                    controller_api: {
                        ...values.controller_api, //只要form中的这些值
                        file_suffix: 'php', //生成文件的后缀名称
                    },
                    table_name: tableName,
                    code_name: 'controller_api', //生成的代码名称
                }).then(res => {
                    if (res.code === 1) {
                        message.success(res.message);
                        formRef.current.setFieldValue('controller_api_code', res.data.controller_api_code);
                    } else {
        ...
        >
            <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <ProFormList
                    name={['controller_api', 'other_functions']}
                    label="添加其它方法"
                    creatorButtonProps={{
                ...
                <ProForm.Item name="controller_api_code" >
