...
export const adminCodeGeneratorApi = {
    ...
    getMysqlConfig: (params = {}) => {
        return http.get('/app/admin/admin/AdminCodeGenerator/getMysqlConfig', params);
    },
    // 获取所有的表名
    getTableList: (params = {}) => {
        return http.get('/app/admin/admin/AdminCodeGenerator/getTableList', params);
    },
    // 获取所有的表以及每个表的所有的列
    getTableColumnList: (params = {}) => {
        return http.get('/app/admin/admin/AdminCodeGenerator/getTableColumnList', params);
    },
    // 获取单表详情
    getTableInfo: (params = {}) => {
        return http.get('/app/admin/admin/AdminCodeGenerator/getTableInfo', params);
    },
    // 获取某个表的列
