...
const UploadImg = lazy(() => import('@/pages/component/form/uploadImg/index'));
const UploadImgAll = lazy(() => import('@/pages/component/form/uploadImgAll/index'));
const UploadImgVideoAll = lazy(() => import('@/pages/component/form/uploadImgVideoAll/index'));
const Teditor = lazy(() => import('@/pages/component/form/teditor/index'));
const PreviewTeditor = lazy(() => import('@/pages/component/preview/teditor/index'));
const UploadFile = lazy(() => import('@/pages/component/form/uploadFile/index'));
const UploadFileAll = lazy(() => import('@/pages/component/form/uploadFileAll/index'));
const TencentMap = lazy(() => import('@/pages/component/form/tencentMap/index'));
const Province = lazy(() => import('@/pages/component/form/province'));
const ProvinceCity = lazy(() => import('@/pages/component/form/provinceCity'));
const ProvinceCityArea = lazy(() => import('@/pages/component/form/provinceCityArea'));
